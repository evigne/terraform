Below is the Terraform script to automate the setup for migrating from Cluster Autoscaler to Karpenter. This includes creating IAM roles and policies, updating the aws-auth ConfigMap, deploying Karpenter, and configuring necessary resources.

### Terraform Script for Migrating to Karpenter
